...
const HOW_TO_PAGES: &[HelpPage] = &[
    HelpPage {
        ...
        lines: &[
            ...
            "",
            "PISTOL / MAC-10  Hitscan burst weapons.",
            "  A                Fire (auto-fires the burst)",
            "",
            "REVOLVER  Hitscan. Fire once per shot in its burst.",
            "  A                Fire",
            "",
            "SHOTGUN  Single hitscan shot, 2 per turn.",
            "  A                Fire",
            "",
            "GRENADE / CLUMP BOMB  L1 / R1  Fuse: 1 to 5 seconds",
            "",
    ...
    HelpPage {
        ...
        lines: &[
            ...
            "        Infinite ammo. Fast, spread out fire.",
            "",
            "GRENADE  Bounces off terrain. Not wind-affected.",
            "         45 dmg. Blast radius 30px. Infinite ammo.",
            "         Fuse 1-5 seconds (L1/R1 to adjust).",
            "",
            "SHOTGUN  Single precise hitscan shot, up to 25 dmg",
            "         (50 both barrels). Damage falls off the",
            "         further the shot lands from a clean hit.",
            "         Range 220px. Recoil moves the shooter.",
            "         2 shots per turn. Infinite ammo.",
        ],
    },
    HelpPage {
        title: "MORE WEAPONS",
        lines: &[
            ...
            "     75 dmg. Blast radius 75px. 1 use.",
            "",
            "LANDMINE  Placed. Arms after 3 seconds.",
            "          Proximity triggered. 50 dmg. 2 uses.",
            "",
            "MOLOTOV COCKTAIL  Thrown, shatters on impact.",
            "          Small blast + a wide pool of fire that",
            "          burns for about 2.5 minutes. 2 uses.",
            "",
            "CLUMP BOMB  Grenade that splits into 5 bomblets",
            "            on impact, each exploding separately",
            "            in a spread pattern. 2 uses.",
            "",
            "GRAPPLE HOOK  Free movement. 5 uses + crates.",
    ...
    HelpPage {
        ...
        lines: &[
            ...
            "              28px reach.",
            "",
            "HOMING MISSILE  1 use per loadout + crates.",
            "          Locked until 2 full turn rotations.",
            "          Flies like a Bazooka, then locks on and",
            "          steers toward a target after ~1 second.",
            "          45 dmg. Blast radius 30px.",
            "",
            "REVOLVER  Hitscan. 6 shots per turn. Crate-only.",
            "          15 dmg + knockback per shot. Range 800px.",
            "",
            "METEOR BOMB  Crate-only. Explodes on terrain hit.",
            "             Scatters 6 burning fragments outward.",
            "             Barrel/mine chain blasts also scatter",
            "             fragments. Not wind-affected.",
        ],
    },
    HelpPage {
        ...
        lines: &[
            ...
            "           5 dmg per sting (up to 30 if all hit).",
            "           Bees seek the nearest soldier.",
            "",
            ...
            "",
            "AIR STRIKE  Crate-only. Unlocks after 7 turn cycles.",
            "            UP/DOWN moves cursor. A to call strike.",
            "            5 bombs, throws soldiers sideways. 50 dmg.",
            "",
            "HAND OF JERRY  Ultra-rare crate-only (~3% drop).",
            "               LEFT/RIGHT aim column. A to drop.",
            "               Smashes + bounces until water.",
            "               45 dmg per bounce.",
        ],
    },
    HelpPage {
    ...
    HelpPage {
        ...
        lines: &[
            ...
            "  Daily missions       ~25 to 90 each",
            "  Weekly missions      ~100 to 320 each",
    ...
    HelpPage {
        ...
        lines: &[
            ...
            "",
            "DAILY CHALLENGES  3 picked from a pool, reset",
            "  daily. Same for everyone that day, different",
            "  ones tomorrow. Around 25-90 scrap each.",
            "",
            "WEEKLY CHALLENGES  3 picked from a pool, reset",
            "  weekly. Bigger targets, bigger rewards —",
    ...
    HelpPage {
        ...
        lines: &[
            ...
            "Only the BAZOOKA is affected by wind — everything",
            "else flies true.",
            "",
            "High ground limits enemy aim angles.",
            "Blow terrain out from under enemies for ring-outs.",
            "",
            "SHOTGUN: close range, up to 25 dmg, pushes enemies.",
            "A clean centre hit does full damage — a graze does",
            "less. Recoil also moves YOU — use it to reposition.",
            "",
            "GRAPPLE to reach high ground before firing.",
            "Release at the bottom of the swing for distance.",
            "",
            "REVOLVER: 6 shots/turn, 15 dmg each, 800px range.",
            ...
            "Each bounce does 45 dmg. Bounces to water level.",
            "",
            "HOMING MISSILE: fire early — it needs ~1 second of",
            "unguided flight before it locks onto a target.",
        ],
    },
];
