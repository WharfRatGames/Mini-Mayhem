...
// this intentionally DIVERGES from src/net/msg.rs's encode() which unwraps.
// When syncing msg.rs → server/msg.rs, keep this signature; only the struct
// definitions need to stay identical between the two files.
